...
- **Hero** — полноэкранная секция с fade-каруселью фото туров (Embla), центральный логотип, затемняющий градиент только в нижней половине кадра для читаемости текста снизу.
