...
export function Button({ children, className, ...props }: ButtonProps) {
  const classes = cn(
    'bg-terracotta text-cream-100 inline-block rounded-md px-9 py-4 font-mono text-base font-bold tracking-widest uppercase transition duration-200 ease-out hover:brightness-110',
    className,
  );
